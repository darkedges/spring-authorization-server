 ...
 */
public final class OIDCTokenType implements Serializable {
	private static final long serialVersionUID = SpringAuthorizationServerVersion.SERIAL_VERSION_UID;
	public static final OIDCTokenType CODE = new OIDCTokenType("code");
	 ...
	 */
	public OIDCTokenType(String value) {
	...
	public boolean equals(Object obj) {
		...
		OIDCTokenType that = (OIDCTokenType) obj;
