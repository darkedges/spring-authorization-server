...
/**
 * A {@code Consumer} providing access to the {@link OAuth2PushedAuthorizationRequestAuthenticationContext}
 * containing an {@link OAuth2PushedAuthorizationRequestAuthenticationToken}
 * and is the default {@link OAuth2PushedAuthorizationRequestAuthenticationProvider#setAuthenticationValidator(Consumer) authentication validator}
 * used for validating specific OAuth 2.0 Authorization Request parameters used in the Authorization Code Grant.
 *
 * <p>
 * The default implementation first validates {@link OAuth2PushedAuthorizationRequestAuthenticationToken#getRedirectUri()}
 * and then {@link OAuth2PushedAuthorizationRequestAuthenticationToken#getScopes()}.
 * If validation fails, an {@link OAuth2PushedAuthorizationRequestAuthenticationException} is thrown.
 *
 * @author Joe Grandja
 ...
 * @since 0.4.0
 */
public class OAuth2PushedAuthorizationRequestAuthenticationValidator implements Consumer<OAuth2PushedAuthorizationRequestAuthenticationContext> {
	private static final String ERROR_URI = "https://datatracker.ietf.org/doc/html/rfc6749#section-4.1.2.1";
	/**
	 * The default validator for {@link OAuth2PushedAuthorizationRequestAuthenticationToken#getScopes()}.
	 */
	public static final Consumer<OAuth2PushedAuthorizationRequestAuthenticationContext> DEFAULT_SCOPE_VALIDATOR =
			OAuth2PushedAuthorizationRequestAuthenticationValidator::validateScope;
	/**
	 * The default validator for {@link OAuth2PushedAuthorizationRequestAuthenticationToken#getRedirectUri()}.
	 */
	public static final Consumer<OAuth2PushedAuthorizationRequestAuthenticationContext> DEFAULT_REDIRECT_URI_VALIDATOR =
			OAuth2PushedAuthorizationRequestAuthenticationValidator::validateRedirectUri;
	private final Consumer<OAuth2PushedAuthorizationRequestAuthenticationContext> authenticationValidator =
			DEFAULT_REDIRECT_URI_VALIDATOR.andThen(DEFAULT_SCOPE_VALIDATOR);

	private static void validateRedirectUri(OAuth2PushedAuthorizationRequestAuthenticationContext authenticationContext) {
